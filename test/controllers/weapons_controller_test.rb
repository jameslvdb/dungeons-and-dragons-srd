...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { category: @weapon.category, damage: @weapon.damage, damage_type: @weapon.damage_type, description: @weapon.description, name: @weapon.name, range: @weapon.range, two_handed_damage: @weapon.two_handed_damage, value: @weapon.value, weapon_type: @weapon.weapon_type, weight: @weapon.weight } }
    end
